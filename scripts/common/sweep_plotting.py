...
def draw_boxplot(ax, data, position, color, box_width,alpha=0.6, showfliers=True, hatch="") -> None:
    ax.boxplot(
        data,
        positions=[position],
        widths=box_width,
        ...
        boxprops=dict(facecolor=color, alpha=alpha, hatch=hatch, edgecolor="black"),
