...
SIM_HALF_WIDTH_KM = 400.0               # half-width of the simulation environment
CLIP_PERCENTILE = 99.9            # population clip
...
def main() -> None:
    ...
    eddf = read_box(dataset, *latlon_box_to_native(transformer, *EDDF, half_km=SIM_HALF_WIDTH_KM))
