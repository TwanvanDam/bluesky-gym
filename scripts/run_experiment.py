...
def train_model(
    ...
    metadata = {
        ...
        "status": "running",
        "convergence_fix" : "applied" if (experiment_config.population_config is not None
                                          and experiment_config.population_config.correct_meridian_convergence) else "not_applied"
    }
    if slurm_job_id:
